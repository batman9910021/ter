...
help_string = '''
<b><a href='https://t.me/Cloud_station9'>Cloud-Station-Mirror</a></b> - The Ultimate Telegram MIrror-Leech Bot to Upload Your File & Link in Google Drive & Telegram
...
def main():
    ...
    if ospath.isfile(".restartmsg"):
        with open(".restartmsg") as f:
            chat_id, msg_id = map(int, f)
        msg = f"<b>Every New End is a New Begining.\n\nBot Got Re-Started ⚡️\n{jam}\n\n🗺️ TimeZone: {TIMEZONE}\n\nPlease Re-Add the Torrents</b>"

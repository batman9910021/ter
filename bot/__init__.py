...
AUTO_DELETE_REPLY_MESSAGE_DURATION = environ.get(
    "AUTO_DELETE_REPLY_MESSAGE_DURATION", ""
)
if len(AUTO_DELETE_REPLY_MESSAGE_DURATION) == 0:
    AUTO_DELETE_REPLY_MESSAGE_DURATION = 0
    log_warning("AUTO_DELETE_REPLY_MESSAGE_DURATION not provided")
else:
    AUTO_DELETE_REPLY_MESSAGE_DURATION = int(AUTO_DELETE_REPLY_MESSAGE_DURATION)
